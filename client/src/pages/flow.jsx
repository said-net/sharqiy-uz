            ...
            {isLoad && product?.title &&
                <>
                    ...
                    <div className="flex items-center justify-center w-full fixed bottom-[60px] left-0">
                        <Button onClick={() => (setOpenShop({ ...openShop, id: p?.id, title: p?.title, bonus: p?.bonus, bonus_count: p?.bonus_count, bonus_given: p?.bonus_given, flow: flow }))} className="w-[98%] h-[50px] rounded-full text-[16px]" color="red">Sotib olish</Button>
                    </div>
                </>
            }
